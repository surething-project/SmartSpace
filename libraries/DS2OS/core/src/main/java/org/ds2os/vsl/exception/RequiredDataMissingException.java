...
/**
 * This exception is thrown when adding nodes from a serialized stream and some required properties
 * are missing (e.g. the type="").
 *
 * @author Pahl
 */
public class RequiredDataMissingException extends VslException {
     ...
     * The major error code of this exception.
     */
    private static final byte ERROR_CODE_MINOR = 66;
     ...
     */
    public RequiredDataMissingException(final String message) {
        super(message);
    }
     ...
     *            unknown.)
     */
    public RequiredDataMissingException(final Throwable cause) {
        super(cause);
    }
