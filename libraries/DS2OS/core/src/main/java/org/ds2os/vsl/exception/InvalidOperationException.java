...
/**
 * This exception is thrown when a executed operation isn't valid (e.g. set or subscribe not
 * supported by a virtual Node.)
 *
 * @author liebald
 */
public class InvalidOperationException extends VslException {
    /**
     * Serial version uid.
     */
