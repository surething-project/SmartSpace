...
/**
 * This exception is thrown by the IModelRepository if no type is given for a model to be stored.
 *
 * @author Pahl
 */
public class TypeMissingException extends VslException {
     ...
     * The major error code of this exception.
     */
    private static final byte ERROR_CODE_MINOR = 65;
     ...
     */
    public TypeMissingException(final String message) {
        super(message);
    }
     ...
     *            unknown.)
     */
    public TypeMissingException(final Throwable cause) {
        super(cause);
    }
