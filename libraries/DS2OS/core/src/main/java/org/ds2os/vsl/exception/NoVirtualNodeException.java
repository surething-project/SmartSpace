...
/**
 * Exception that is thrown when a node is queried as virtual Node, but it isn't a virtual node.
 *
 * @author Pahl, liebald
 */
public class NoVirtualNodeException extends VslException {
     ...
     */
    public NoVirtualNodeException(final String message) {
        super(message);
    }
