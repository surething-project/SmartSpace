...
/**
 * Exception that is thrown when a node is added to an address that is already existing.
 *
 * @author Pahl
 */
public class NodeAlreadyExistingException extends VslException {
     ...
     */
    public NodeAlreadyExistingException(final String message) {
        super(message);
    }
