...
/**
 * This exception is thrown by the IKnowledgeObjectRegister. It indicated that a model (given by ID)
 * could not be found.
 *
 * @author Pahl
 */
public class ParentNotExistingException extends VslException {
     ...
     * The major error code of this exception.
     */
    private static final byte ERROR_CODE_MINOR = 12;
     ...
     */
    public ParentNotExistingException(final String message) {
        super(message);
    }
     ...
     *            unknown.)
     */
    public ParentNotExistingException(final Throwable cause) {
        super(cause);
    }
