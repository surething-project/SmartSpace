...
/**
 * This exception is thrown by the IModelRepository. It indicates that there is already a model
 * stored under the given ID.
 *
 * @author Pahl
 */
public class ModelIDExistsAlreadyException extends VslException {
     ...
     */
    public ModelIDExistsAlreadyException(final String message) {
        super(message);
    }
     ...
     *            unknown.)
     */
    public ModelIDExistsAlreadyException(final Throwable cause) {
        super(cause);
    }
