...
/**
 * Exception that is thrown when a List operation is invalid.
 *
 * @author Pahl
 */
public class ListOperationInvalidException extends VslException {
     ...
     */
    public ListOperationInvalidException(final String message) {
        super(message);
    }
