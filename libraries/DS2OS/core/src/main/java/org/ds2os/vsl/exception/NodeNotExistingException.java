...
/**
 * Exception that is thrown when a node is not existing and should be deleted.
 *
 * @author Pahl
 */
public class NodeNotExistingException extends VslException {
     ...
     */
    public NodeNotExistingException(final String message) {
        super(message);
    }
