...
/**
 * This exception is thrown by the by the KORSyncHandler. It indicates that a handshake is already
 * in progress while a new one was requested.
 *
 * @author liebald
 */
public class KorSyncAlreadyInProgressException extends VslException {
    /**
     * Serial version uid.
     */
     ...
     */
    private static final byte ERROR_CODE_MINOR = 9;
     ...
     */
    public KorSyncAlreadyInProgressException(final String message) {
        super(message);
    }
     ...
     *            unknown.)
     */
    public KorSyncAlreadyInProgressException(final Throwable cause) {
        super(cause);
    }
