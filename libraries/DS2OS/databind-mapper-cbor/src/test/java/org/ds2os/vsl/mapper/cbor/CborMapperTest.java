...
/**
 * Test mapping of VSL datatypes to CBOR with the {@link CborMapper} .
 *
 * @author felix
 */
public final class CborMapperTest {
    ...
    private final VslMapper unitUnderTest = new DatabindMapperFactory(nodeFactory)
            .getMapper(VslMimeTypes.CBOR);

    /**
     * Test CBOR serialization of a simple node.
     *
     * @throws IOException
     *             Must not happen.
     */
    ...
    /**
     * Test CBOR serialization of a node with a child.
     *
     * @throws IOException
     *             Must not happen.
     */
