 ...
 * {@link OrientdbDatabase}.
 *
 * @author liebald
 * @author gogrichani
 */
// disabled by default, since only working when orientdb is actually used/configured
@Ignore
public class ITorientDatabaseTest {
    ...
    /**
     * Issues a thread.sleep(milliseconds) and catches exceptions.
     *
     * @param milliseconds
     *            the amount of time the test should wait.
     */
    ...
    public final void setUp() {
        ...
        when(configMock.getDatabaseType()).thenReturn("orientdb");
        ...
        db = new OrientdbDatabase(configMock);
        db.activate();
